		...
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
			  ...
			  <div class="row x_title">
			  		<div class="col-md-6">
					<h3>Data Situs Sewa</h3>  
					</div>
			  </div>
              <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12"  style="color:white;">
                <div class="tile-stats" style="background:#4286f4;">
                  <div class="icon"><i class="fa fa-users" style="color:white;"></i></div>
                  <div class="count" style="color:white;"><?= $Jumlah_User; ?></div>
                  <h3 style="color:white;">Pengguna</h3>
