                  ...
                  <div class="x_content">
                      ...
                      ?>                  
                          ...
                          <td><?= $no++ ?></td>
                            ...
                            <a class="btn btn-primary" data-toggle="modal" data-target="#edit" href="#"  onclick="edit('<?=$data->id_barang?>')" >Konfirmasi</a>
                            <a class="btn btn-danger" data-toggle="modal" data-target="#edit" href="#"  onclick="edit('<?=$data->id_barang?>')" >Tolak</a>
